...
export default function Login() {
  ...
  return (
    <div>
        ...
        <Flex flexDir={'column'}mt={{base:'150px',md:'150px',lg:'180px',xl:'200px'}} bgColor={'white'} py={'20px'} w={{base:'90%',xl:'50%'}} mr={'auto'} ml={'auto'}>
            <Flex flexDirection={'row'} justify={'center'} align={'center'} mb={'20px'}>
                ...
                <Heading fontFamily={'mono'} mt={'30px'} color={'#213655'}>Login</Heading>
            </Flex>
                    ...
                    <Form>
                            ...
                            <FormControl mb={'30px'}>
                                <InputGroup>
                                    ...
                                    <Input type="email" value={email}  placeholder="Email" w={'100%'} border={'1px solid gray'}  outline={'none'} onChange={handleEmailChange}/>        
                                </InputGroup>
                            </FormControl>
                        ...
                        <FormControl mb={'30px'}>
                            <InputGroup>
                                ...
                                <Input type={show ? 'text' : 'password'} value={password} placeholder="Password" w={'100%'} border={'1px solid gray'} onChange={handlePasswordChange}/>

                            </InputGroup>
                        </FormControl>
                        <Flex justify={'center'} mb={'30px'}>
                            <Button type="submit" colorScheme="red" w={'30%'}>Jump In</Button>
                        </Flex>                        
                    </Form>
                    
                    <Box pos={'absolute'} w={{base:'100px',md:'130px',lg:'150px', xl:'150px'}} bottom={'10%'}>
