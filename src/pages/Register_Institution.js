  ...
  return (
    ...
    <GoogleOAuthProvider clientId="950695587102-tshfvmoi0kj2fasfmiiem3ed022eaf19.apps.googleusercontent.com">
            ...
            <Flex flexDirection={'row'} justify={'center'} align={'center'} mb={'20px'}>
                ...
                <Heading fontFamily={'mono'} mt={'30px'} color={'#213655'}>Sign Up as an Institution</Heading>
            </Flex>
                    ...
                    <Form method='post' action="/register-institution">
                        <FormControl mb={'30px'} >
                            <InputGroup alignItems={'center'}>
                                ...
                                <Input type="text" name="name" placeholder="Institution Name" w={'100%'} border={'1px solid gray'}/>
                            ...
                            <FormControl mb={'30px'}>
                                <InputGroup>
                                    ...
                                    <Input type="email" name="email"  placeholder="Institution Email" w={'100%'} border={'1px solid gray'}  outline={'none'} />        
                                </InputGroup>
                            </FormControl>
                        ...
                        <Flex justify={'center'} mb={'30px'}>
                            <Button type="submit" colorScheme="red" w={'30%'}>Get Started</Button>
                        </Flex>
